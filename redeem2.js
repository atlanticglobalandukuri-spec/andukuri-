...
import { getDatabase, ref, push, update, get, set } from "https://www.gstatic.com/firebasejs/12.5.0/firebase-database.js";
...
const profileConfig = {
  ...
  appId: "1:400864661441:web:b011d12acb22bae245fdae",
...
document.getElementById("scoreDisplay").innerText = currentUser.score;
...
submitBtn.addEventListener("click", async () => {
  ...
  try {
    ...
    document.getElementById("scoreDisplay").innerText = newScore;
    updateButtonState();
